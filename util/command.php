<?php
    ...
    function show_footer() {
        echo "  <footer>
                    <h5 class='footer__title'>Nonostante le incertezze e le prove che la vita ci presenti, <br> troviamo la volontà di perseverare e di lottare per un futuro migliore.</h5> <!-- Titolo sopra tutto il resto -->
                    <br> <hr class='footer__hr'> <br> <br>
